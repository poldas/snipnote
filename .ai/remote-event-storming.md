...
<mermaid_update>
1. Diagram: Używaj typu "flowchart LR" (Left to Right) dla zachowania chronologii wydarzeń w ćwiczeniu Event Stormingu. Będzie on aktualizowany w formie interaktywnego artefaktu.
...
6. Zachowanie stanu:
   ...
   - Zawsze aktualizuj artefakt warsztatowy zgodnie z zasadami określonymi w sekcji <mermaid_update>.
